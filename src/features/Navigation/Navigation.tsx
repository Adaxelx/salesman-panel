...
import { HamburgerButton, LanguageSwitch, Select, SelectOption } from 'components';
...
const Navigation = ({ toggleLanguage, language }: NavigationProps) => {
  ...
  return (
    <>
      ...
      <Portal>
        <div
          className={`fixed w-full h-full transform top-0 left-0 transition  bg-secondary flex flex-col p-4 pt-12 ${
